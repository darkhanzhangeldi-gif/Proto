const venues = [
  {
    ...
    rating: 4.9,
    type: "Wedding",
    image: "https://images.unsplash.com/photo-1519167758481-83f29c7f28b5?auto=format&fit=crop&w=1200&q=80",
    booked: true,
  },
  {
    id: 2,
...
const providers = [
  ...
  },
  {
    ...
    city: "Astana",
    image: "https://images.unsplash.com/photo-1513278974582-3e1b4a4fa21d?auto=format&fit=crop&w=1000&q=80",
  },
  {
    id: 3,
    category: "Catering",
...
const timeline = [
  { id: 1, time: "10:00", event: "Makeup & hair starts", place: "Bridal suite" },
...
function renderVenueSelectorCard() {
  ...
  if (!selected) {
    wrapper.innerHTML = "<p>No venue selected yet.</p>";
    return;
  }
      ...
      <article class="provider-card">
        ...
        <div class="provider-body">
          ...
          <div class="card-actions">
            ...
            <button class="detail-btn">Save</button>
          </div>
        </div>
      </article>
    `
